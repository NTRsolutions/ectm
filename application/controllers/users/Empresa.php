...
class Empresa extends CI_Controller {
    ...
    public function index()
    {
        ...
        $data['main_content'] = $this->load->view('users/empresa/add', $data, TRUE);
    ...
    public function empresa_lista()
    {
    	...
    	$data['empresas'] = $this->empresa_model->get_all_empresas($this->session->userdata('idempresa'));
        $data['country'] = $this->common_model->select('country');
        //$data['count'] = $this->empresa_model->get_empresa_total();
        $data['main_content'] = $this->load->view('users/empresa/empresas', $data, TRUE);
        $this->load->view('admin/index', $data);
    }
