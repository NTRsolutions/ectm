        ...
        <div class="col-lg-12">
            ...
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white"> Nova empresa <a href="<?php echo base_url('admin/empresa/empresa_lista') ?>" class="btn btn-info pull-right"><i class="fa fa-list"></i> Voltar </a></h4>

                </div>
                <div class="card-body">
                    <form method="post" action="<?php echo base_url('admin/empresa/add') ?>" class="form-horizontal" novalidate>
                        <div class="form-body">
                            <br>
                            <div class="row">
                                <div class="col-md-9">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="controls">
                                            <div class="form-check">
                                                ...
                                                <label class="custom-control custom-radio">
                                                    <input id="admin" name="role" type="radio" value="admin" class="custom-control-input" required data-validation-required-message="Voc&ecirc; precisa selecionar uma fun&ccedil;&atilde;o" aria-invalid="false">   
                                                    <span class="custom-control-indicator"></span>
