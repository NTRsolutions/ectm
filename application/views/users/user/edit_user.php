    ...
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Alterar usu&aacute;rio </li>
            </ol>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white"> Alterar <a href="<?php echo base_url('users/user/all_user_list') ?>" class="btn btn-info pull-right"><i class="fa fa-list"></i> Voltar </a></h4>

                </div>
                <div class="card-body">
                    <form method="post" action="<?php echo base_url('users/user/update/'.$user->id) ?>" class="form-horizontal" novalidate>
                    
                      <input type="hidden" name="idempresa" value="<?php echo $user->idempresa; ?>" />
                        ...
                        <div class="form-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="controls">
                                            <div class="form-check">
                                                ...
                                                <label class="custom-control custom-radio">
                                                    <input <?php if($user->role == "superv"){echo "checked";}; ?> id="admin" name="role" type="radio" value="superv" class="custom-control-input" required data-validation-required-message="You need to select user role type" aria-invalid="false">
                                                    <span class="custom-control-indicator"></span>
                            ...
                            <div class="row user_role_area" style="display: <?php echo $dis; ?>">
                                <div class="col-md-9">
                                    <div class="form-group row">
                                        <label class="control-label text-right col-md-3">Permiss&atilde;o do usu&aacute;rio </label>
                                        <div class="controls">
