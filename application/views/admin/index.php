...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url() ?>assets/images/ectm.png">
    <title>eCTM</title>
    <!-- Bootstrap Core CSS -->
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="<?php echo base_url('admin/dashboard') ?>">
                        <!-- Logo icon -->
		                <span class="fa fa-paper-plane" aria-hidden="true" title="Logo">eCTM</span>
		             </a>   
                </div>
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li>
                           <?php if ($this->session->userdata('role') == 'admin'): ?>
                              <a class="has-arrow waves-effect waves-dark" href="<?php echo base_url('admin/empresa/all_user_list') ?>" aria-expanded="false"><i class="fa fa-user"></i><span class="hide-menu">Empresas</span></a>
                              <ul aria-expanded="false" class="collapse">
                            </ul>
                            <?php else : ?>
                              <a class="waves-effect waves-dark" href="<?php echo base_url('users/empresa/empresa_lista') ?>" aria-expanded="false"><i class="fa fa-user"></i><span class="hide-menu">Empresa</span></a>
                           <?php endif ?>
                        </li>
                        <li>
                            <?php if ($this->session->userdata('role') == 'admin'): ?>
                                <a class="has-arrow waves-effect waves-dark" href="<?php echo base_url('admin/user/all_user_list') ?>" aria-expanded="false"><i class="fa fa-user"></i><span class="hide-menu">Usu&aacute;rios</span></a>
                              <?php else : ?>
                                    <a class="has-arrow waves-effect waves-dark" href="<?php echo base_url('users/user/all_user_list') ?>" aria-expanded="false"><i class="fa fa-user"></i><span class="hide-menu">Usu&aacute;rios</span></a>
                                <?php endif ?>

                            <ul aria-expanded="false" class="collapse">
                                <?php if ($this->session->userdata('role') == 'admin'): ?>
                                <li><a href="<?php echo base_url('admin/user/all_user_list') ?>"><i class="fa fa-angle-right"></i> Listar usu&aacute;rios </a></li>
                                <?php else : ?>
                                <li><a href="<?php echo base_url('users/user/all_user_list') ?>"><i class="fa fa-angle-right"></i> Listar usu&aacute;rios </a></li>
                        ...
                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-menu"></i><span class="hide-menu">Cadastros</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url('users/aeronave/aeronave_lista') ?>"><i class="fa fa-paper-plane"></i> Aeronaves </a></li>
                                <li><a href="<?php echo base_url('#') ?>"><i class="fa fa-cog"></i> Motores </a></li>
                                <li><a href="<?php echo base_url('#') ?>"><i class="fa fa-empire"></i> H&eacute;lice </a></li>
                            </ul>
                        </li>

                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="fa fa-cubes"></i><span class="hide-menu">Componentes</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url('admin/items') ?>"><i class="fa fa-calendar"></i> Controlados </a></li>
                                <li><a href="<?php echo base_url('admin/items/add') ?>"><i class="fa fa-calendar-o"></i> N&atilde;o Controlados </a></li>
                            </ul>
                        </li>
